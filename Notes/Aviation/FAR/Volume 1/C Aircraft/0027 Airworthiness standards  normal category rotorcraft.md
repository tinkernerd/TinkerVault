...
category: Aviation
title: 0027 Airworthiness standards  normal category rotorcraft
topic:
...
\(iv\) The highest weight in which the provisions of [[0027 Airworthiness standards  normal category rotorcraft#§27.87   Height-speed envelope.|§§27.87]] or 27.143(c)(1), or combinations thereof, are demonstrated if the weights and operating conditions (altitude and temperature) prescribed by those requirements cannot be met; and

\(2\) Not less than the sum of—

\(i\) The empty weight determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.29   Empty weight and corresponding center of gravity.|§27.29]]; and
...
\(2\) Structural component approval for external load operations under either [[0027 Airworthiness standards  normal category rotorcraft#§27.865   External loads.|§27.865]] or under equivalent operational standards is obtained,
...
\(5\) Operation of the rotorcraft at a total weight greater than the maximum certificated weight established under paragraph (a) of this section is limited by appropriate operating limitations under [[0027 Airworthiness standards  normal category rotorcraft#§27.865   External loads.|§27.865]](a) and (d) of this part.
...
The extreme forward and aft centers of gravity and, where critical, the extreme lateral centers of gravity must be established for each weight established under [[0027 Airworthiness standards  normal category rotorcraft#§27.25   Weight limits.|§27.25]]. Such an extreme may not lie beyond—
...
For single-engine helicopters and multiengine helicopters that do not meet the Category A engine isolation requirements of [[0029 Airworthiness standards  transport category rotorcraft|Part 29 of this chapter]], the minimum rate of descent airspeed and the best angle-of-glide airspeed must be determined in autorotation at—
...
\(1\) Sudden failure of one engine, for multiengine rotorcraft meeting Transport Category A engine isolation requirements of [[0029 Airworthiness standards  transport category rotorcraft|Part 29 of this chapter]];

\(2\) Sudden, complete power failure for other rotorcraft; and

\(3\) Sudden, complete control system failures specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.695   Power boost and power-operated control system.|§27.695]] of this part; and
...
\(f\) For helicopters for which a V*NE* (power-off) is established under [[0027 Airworthiness standards  normal category rotorcraft#§27.1505   Never-exceed speed.|§27.1505]](c), compliance must be demonstrated with the following requirements with critical weight, critical center of gravity, and critical rotor r.p.m.:
...
\(b\) Throughout the full range of altitude for which certification is requested, with the throttle and collective pitch held constant during the maneuvers specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.175   Demonstration of static longitudinal stability.|§27.175]](a) through (d), the slope of the control position versus airspeed curve must be positive. However, in limited flight conditions or modes of operation determined by the Administrator to be acceptable, the slope of the control position versus airspeed curve may be neutral or negative if the rotorcraft possesses flight characteristics that allow the pilot to maintain airspeed within ±5 knots of the desired trim airspeed without exceptional piloting skill or alertness.
...
\(2\) The steady state sideslip angles established by [[0027 Airworthiness standards  normal category rotorcraft#§27.351   Yawing conditions.|§27.351]];
...
\(1\) Displace the cockpit directional control suddenly to the maximum deflection limited by the control stops or by the maximum pilot force specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]](a);
...
\(2\) The torque required by [[0027 Airworthiness standards  normal category rotorcraft#§27.923   Rotor drive system and control mechanism tests.|§27.923]];

\(3\) The torque required by [[0027 Airworthiness standards  normal category rotorcraft#§27.927   Additional tests.|§27.927]]; or
...
Each auxiliary rotor, each fixed or movable stabilizing or control surface, and each system operating any flight control must meet the requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.395   Control system.|§§27.395]], 27.397, 27.399, 27.411, and 27.427.
...
\(1\) The forces specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]]; or

\(2\) If the system prevents the pilot from applying the limit pilot forces to the system, the maximum forces that the system allows the pilot to apply, but not less than 0.60 times the forces specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]].

\(b\) Each primary control system, including its supporting structure, must be designed as follows:

\(1\) The system must withstand loads resulting from the limit pilot forces prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]].
...
\(3\) If the system design or the normal operating loads are such that a part of the system cannot react to the limit pilot forces prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]], that part of the system must be designed to withstand the maximum loads that can be obtained in normal operation. The minimum design loads must, in any case, provide a rugged system for service use, including consideration of fatigue, jamming, ground gusts, control inertia, and friction loads. In the absence of rational analysis, the design loads resulting from 0.60 of the specified limit pilot forces are acceptable minimum design loads.

\(4\) If operational loads may be exceeded through jamming, ground gusts, control inertia, or friction, the system must withstand the limit pilot forces specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]], without yielding.
...
Each dual primary flight control system must be designed to withstand the loads that result when pilot forces of 0.75 times those obtained under [[0027 Airworthiness standards  normal category rotorcraft#§27.395   Control system.|§27.395]] are applied—
...
\(b\) Unless otherwise prescribed, for each specified landing condition, the rotorcraft must be designed for a limit load factor of not less than the limit inertia load factor substantiated under [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§27.725]].
...
\(1\) Vertical loads applied under [[0027 Airworthiness standards  normal category rotorcraft#§27.471   General.|§27.471]].
...
\(a\) The vertical load must be the same as that obtained on that side under [[0027 Airworthiness standards  normal category rotorcraft#§27.479   Level landing conditions.|§27.479]](b)(1); and
...
\(1\) Side loads combined with one-half of the maximum ground reactions obtained in the level landing conditions of [[0027 Airworthiness standards  normal category rotorcraft#§27.479   Level landing conditions.|§27.479]] (b)(1); and
...
\(1\) 1.33, for the attitude specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.479   Level landing conditions.|§27.479]](a)(1); and

\(2\) 1.0 for the attitude specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.479   Level landing conditions.|§27.479]](a)(2); and
...
\(1\) The vertical loads must be applied under [[0027 Airworthiness standards  normal category rotorcraft#§27.471   General.|§§27.471]] through 27.475;
...
\(1\) The design maximum weight, center of gravity, and load factor must be determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.471   General.|§§27.471]] through 27.475.
...
\(i\) A drop height of 1.5 times that specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§27.725]]; and

\(ii\) An assumed rotor lift of not more than 1.5 times that used in the limit drop tests prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§27.725]].
...
If certification for ski operation is requested, the rotorcraft, with skis, must be designed to withstand the following loading conditions (where *P* is the maximum static weight on each ski with the rotorcraft at design maximum weight, and *n* is the limit load factor determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.473   Ground loading conditions and assumptions.|§27.473]](b).
...
\(c\) The main rotor structure must be designed to withstand the following loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.337   Limit maneuvering load factor.|§§27.337]] through 27.341:
...
\(ii\) The limit engine torque specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.361   Engine torque.|§27.361]].
...
\(1\) The critical loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.337   Limit maneuvering load factor.|§§27.337]] through 27.341;

\(2\) The applicable ground loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.235   Taxiing condition.|§§27.235]], 27.471 through 27.485, 27.493, 27.497, 27.501, 27.505, and 27.521; and

\(3\) The loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.547   Main rotor structure.|§27.547]] (d)(2) and (e).
...
If certification with ditching provisions is requested, structural strength for ditching must meet the requirements of this section and [[0027 Airworthiness standards  normal category rotorcraft#§27.801   Ditching.|§27.801]](e).
...
\(i\) Loads or stresses in all critical conditions throughout the range of limitations in [[0027 Airworthiness standards  normal category rotorcraft#§27.309   Design limitations.|§27.309]], except that maneuvering load factors need not exceed the maximum values expected in operation.
...
\(2\) Each applicant must establish replacement times, inspections, or other procedures for all PSEs to require the repair or replacement of damaged parts before a catastrophic failure. These replacement times, inspections, or other procedures must be included in the Airworthiness Limitations Section of the Instructions for Continued Airworthiness required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1529   Instructions for Continued Airworthiness.|§27.1529]].
...
\(4\) Include these supplemental procedures in the Airworthiness Limitations section of the Instructions for Continued Airworthiness required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1529   Instructions for Continued Airworthiness.|§27.1529]].
...
\(a\) The special factors prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.621   Casting factors.|§§27.621]] through 27.625 apply to each part of the structure whose strength is—
...
\(b\) For each part to which [[0027 Airworthiness standards  normal category rotorcraft#§27.621   Casting factors.|§§27.621]] through 27.625 apply, the factor of safety prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.303   Factor of safety.|§27.303]] must be multiplied by a special factor equal to—

\(1\) The applicable special factors prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.621   Casting factors.|§§27.621]] through 27.625; or
...
\(i\) The strength requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.305   Strength and deformation.|§27.305]] at an ultimate load corresponding to a casting factor of 1.25; and

\(ii\) The deformation requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.305   Strength and deformation.|§27.305]] at a load of 1.15 times the limit load.
...
\(d\) Each seat, berth, litter, safety belt, and harness attachment to the structure must be shown by analysis, tests, or both, to be able to withstand the inertia forces prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b)(3) multiplied by a fitting factor of 1.33.
...
\(b\) The probable range of variations, during service, of the damping action of the ground resonance prevention means must be established and must be investigated during the test required by [[0027 Airworthiness standards  normal category rotorcraft#§27.241   Ground resonance.|§27.241]].
...
The landing inertia load factor and the reserve energy absorption capacity of the landing gear must be substantiated by the tests prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§§27.725]] and 27.727, respectively. These tests must be conducted on the complete rotorcraft or on units consisting of wheel, tire, and shock absorber in their proper relation.
...
\(b\) If considered, the rotor lift specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.473   Ground loading conditions and assumptions.|§27.473]](a) must be introduced into the drop test by appropriate energy absorbing devices or by the use of an effective mass.
...
\(a\) The drop height must be 1.5 times that specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§27.725]](a).

\(b\) Rotor lift, where considered in a manner similar to that prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.725   Limit drop test.|§27.725]](b), may not exceed 1.5 times the lift allowed under that paragraph.
...
\(f\) *Control.* The location and operation of the retraction control must meet the requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.777   Cockpit controls.|§§27.777]] and 27.779.
...
\(2\) The vertical loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.521   Float landing conditions.|§27.521]](a), distributed along the length of the bag over three-quarters of its projected area.

\(b\) *Rigid floats.* Each rigid float must be able to withstand the vertical, horizontal, and side loads prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.521   Float landing conditions.|§27.521]]. These loads may be distributed along the length of the float.
...
\(f\) Each seat and its supporting structure must be designed for an occupant weight of at least 170 pounds considering the maximum load factors, inertial forces, and reactions between occupant, seat, and safety belt or harness corresponding with the applicable flight and ground load conditions, including the emergency landing conditions of [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b). In addition—

\(1\) Each pilot seat must be designed for the reactions resulting from the application of the pilot forces prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.397   Limit pilot forces and torques.|§27.397]]; and

\(2\) The inertial forces prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b) must be multiplied by a factor of 1.33 in determining the strength of the attachment of—

\(i\) Each seat to the structure; and

\(ii\) Each safety belt or harness to the seat or structure.

\(g\) When the safety belt and shoulder harness are combined, the rated strength of the safety belt and shoulder harness may not be less than that corresponding to the inertial forces specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b), considering the occupant weight of at least 170 pounds, considering the dimensional characteristics of the restraint system installation, and using a distribution of at least a 60-percent load to the safety belt and at least a 40-percent load to the shoulder harness. If the safety belt is capable of being used without the shoulder harness, the inertial forces specified must be met by the safety belt alone.

\(h\) When a headrest is used, the headrest and its supporting structure must be designed to resist the inertia forces specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]], with a 1.33 fitting factor and a head weight of at least 13 pounds.
...
\(j\) Each seating device system may use design features such as crushing or separation of certain parts of the seats to reduce occupant loads for the emergency landing dynamic conditions of [[0027 Airworthiness standards  normal category rotorcraft#§27.562   Emergency landing dynamic conditions.|§27.562]]; otherwise, the system must remain intact and must not interfere with rapid evacuation of the rotorcraft.

\(k\) For the purposes of this section, a litter is defined as a device designed to carry a nonambulatory person, primarily in a recumbent position, into and on the rotorcraft. Each berth or litter must be designed to withstand the load reaction of an occupant weight of at least 170 pounds when the occupant is subjected to the forward inertial factors specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b). A berth or litter installed within 15° or less of the longitudinal axis of the rotorcraft must be provided with a padded end-board, cloth diaphram, or equivalent means that can withstand the forward load reaction. A berth or litter oriented greater than 15° with the longitudinal axis of the rotorcraft must be equipped with appropriate restraints, such as straps or safety belts, to withstand the forward load reaction. In addition—
...
\(2\) The berth or litter attachment and the occupant restraint system attachments to the structure must be designed to withstand the critical loads resulting from flight and ground load conditions and from the conditions prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]](b). The fitting factor required by [[0027 Airworthiness standards  normal category rotorcraft#§27.625   Fitting factors.|§27.625]](d) shall be applied.
...
\(c\) Under the emergency landing conditions of [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]], cargo and baggage compartments must—
...
\(2\) Have sufficient strength to withstand the conditions specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]] including the means of restraint, and their attachments, required by paragraph (b) of this section. Sufficient strength must be provided for the maximum authorized weight of cargo and baggage at the critical loading distribution.
...
\(a\) If certification with ditching provisions is requested, the rotorcraft must meet the requirements of this section and [[0027 Airworthiness standards  normal category rotorcraft#§27.807   Emergency exits.|§§27.807]](d), 27.1411 and 27.1415.
...
\(d\) It must be shown that, under reasonably probable water conditions, the flotation time and trim of the rotorcraft will allow the occupants to leave the rotorcraft and enter the life rafts required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1415   Ditching equipment.|§27.1415]]. If compliance with this provision is shown by buoyancy and trim computations, appropriate allowances must be made for probable structural damage and leakage. If the rotorcraft has fuel tanks (with fuel jettisoning provisions) that can reasonably be expected to withstand a ditching without leakage, the jettisonable volume of fuel may be considered as buoyancy volume.
...
\(c\) *Combustion heater fire protection.* Except for heaters which incorporate designs to prevent hazards in the event of fuel leakage in the heater fuel system, fire within the ventilating air passage, or any other heater malfunction, each heater zone must incorporate the fire protection features of the applicable requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1183   Lines, fittings, and components.|§§27.1183]], 27.1185, 27.1189, 27.1191, and be provided with—
...
\(i\) *Heater exhaust.* Each heater exhaust system must meet the requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1121   General.|§§27.1121]] and 27.1123.
...
\(e\) A placard or marking must be installed next to the external-load attaching means clearly stating any operational limitations and the maximum authorized external load as demonstrated under [[0027 Airworthiness standards  normal category rotorcraft#§27.25   Weight limits.|§27.25]] and this section.

\(f\) The fatigue evaluation of [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]] of this part does not apply to rotorcraft-load combinations to be used for nonhuman external cargo except for the failure of critical structural elements that would result in a hazard to the rotorcraft. For rotorcraft-load combinations to be used for human external cargo, the fatigue evaluation of [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]] of this part applies to the entire quick release and personnel carrying device structural systems and their attachments.
...
\(1\) The installation instructions provided under [[0033 Airworthiness standards  aircraft engines#§33.5   Instruction manual for installing and operating the engine.|§33.5]] of this chapter; and
...
\(2\) Unless a fatigue evaluation under [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]] is conducted, it must be shown that cooling fan blades are not operating at resonant conditions within the operating limits of the rotorcraft.
...
\(i\) The maximum torque used in meeting [[0027 Airworthiness standards  normal category rotorcraft#§27.923   Rotor drive system and control mechanism tests.|§27.923]] plus 10 percent; or
...
\(2\) All individual breakaway couplings, coupling fuel feed systems, or equivalent means must be designed, tested, installed, and maintained so that inadvertent fuel shutoff in flight is improbable in accordance with [[0027 Airworthiness standards  normal category rotorcraft#§27.955   Fuel flow.|§27.955]](a) and must comply with the fatigue evaluation requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]] without leaking.

\(3\) Alternate, equivalent means to the use of breakaway couplings must not create a survivable impact-induced load on the fuel line to which it is installed greater than 25 to 50 percent of the ultimate load (strength) of the weakest component in the line and must comply with the fatigue requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]] without leaking.
...
\(3\) All frangible or locally deformable attachments must comply with the fatigue requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.571   Fatigue evaluation of flight structure.|§27.571]].
...
\(1\) Independent tank outlets for each engine, each incorporating a shutoff valve at the tank. This shutoff valve may also serve as the firewall shutoff valve required by [[0027 Airworthiness standards  normal category rotorcraft#§27.995   Fuel valves.|§27.995]] if the line between the valve and the engine compartment does not contain a hazardous amount of fuel that can drain into the engine compartment.
...
\(2\) The fuel level in the tank may not exceed that established as the unusable fuel supply for that tank under [[0027 Airworthiness standards  normal category rotorcraft#§27.959   Unusable fuel supply.|§27.959]], plus the minimum additional fuel necessary to conduct the test.
...
\(7\) The fuel filter required by [[0027 Airworthiness standards  normal category rotorcraft#§27.997   Fuel strainer or filter.|§27.997]] must be blocked to the degree necessary to simulate the accumulation of fuel contamination required to activate the indicator required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1305   Powerplant instruments.|§27.1305]](q).
...
Each suction lift fuel system and other fuel systems with features conducive to vapor formation must be shown by test to operate satisfactorily (within certification limits) when using fuel at a temperature of 110 °F under critical operating conditions including, if applicable, the engine operating conditions defined by [[0027 Airworthiness standards  normal category rotorcraft#§27.927   Additional tests.|§27.927]] (b)(1) and (b)(2).
...
\(c\) The location of each tank must meet the requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1185   Flammable fluids.|§27.1185]] (a) and (c).
...
\(b\) Each sump, sediment bowl, and sediment chamber drain required by this section must comply with the drain provisions of [[0027 Airworthiness standards  normal category rotorcraft#§27.999   Fuel system drains.|§27.999]](b).

\[Amdt. 27-23, 53 FR 34213, Sept. 2, 1988\]

### §27.973   Fuel tank filler connection.

\(a\) Each fuel tank filler connection must prevent the entrance of fuel into any part of the rotorcraft other than the tank itself during normal operations and must be crash resistant during a survivable impact in accordance with [[0027 Airworthiness standards  normal category rotorcraft#§27.952   Fuel system crash resistance.|§27.952]](c). In addition—

\(1\) Each filler must be marked as prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1557   Miscellaneous markings and placards.|§27.1557]](c)(1);
...
Compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.955   Fuel flow.|§27.955]] may not be jeopardized by failure of—
...
\(5\) An oil strainer or filter that has no bypass, except one that is installed at an oil tank outlet, must have a means to connect it to the warning system required in [[0027 Airworthiness standards  normal category rotorcraft#§27.1305   Powerplant instruments.|§27.1305]](r).
...
\(b\) Pressure lubrication systems for transmissions and gearboxes must comply with the engine oil system requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1013   Oil tanks.|§§27.1013]] (except paragraph (c)), 27.1015, 27.1017, 27.1021, and 27.1337(d).
...
\(e\) Splash-type lubrication systems for rotor drive system gearboxes must comply with [[0027 Airworthiness standards  normal category rotorcraft#§27.1021   Oil system drains.|§§27.1021]] and 27.1337(d).
...
\(a\) *General.* For the tests prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1041   General.|§27.1041]](b), the following apply:
...
\(4\) The test procedures must be as prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1045   Cooling test procedures.|§27.1045]].
...
\(i\) Without accumulating ice on engine or inlet system components that would adversely affect engine operation or cause a serious loss of power under the icing conditions specified in appendix C of [[0029 Airworthiness standards  transport category rotorcraft|Part 29 of this chapter]]; and
...
\(a\) Powerplant controls must be located and arranged under [[0027 Airworthiness standards  normal category rotorcraft#§27.777   Cockpit controls.|§27.777]] and marked under [[0027 Airworthiness standards  normal category rotorcraft#§27.1555   Control markings.|§27.1555]].
...
\(2\) Not protected under [[0027 Airworthiness standards  normal category rotorcraft#§27.861   Fire protection of structure, controls, and other parts.|§27.861]].
...
\(3\) Rotorcraft for which compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.1043   Cooling tests.|§27.1043]] is shown in any condition other than the most critical flight condition with respect to cooling.
...
\(m\) Means to indicate to the flightcrew the failure of any fuel pump installed to show compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.955   Fuel flow.|§27.955]].

\(n\) A gas temperature indicator for each turbine engine.

\(o\) Means to enable the pilot to determine the torque of each turboshaft engine, if a torque limitation is established for that engine under [[0027 Airworthiness standards  normal category rotorcraft#§27.1521   Powerplant limitations.|§27.1521]](e).

\(p\) For each turbine engine, an indicator to indicate the functioning of the powerplant ice protection system.

\(q\) An indicator for the fuel filter required by [[0027 Airworthiness standards  normal category rotorcraft#§27.997   Fuel strainer or filter.|§27.997]] to indicate the occurrence of contamination of the filter at the degree established by the applicant in compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.955   Fuel flow.|§27.955]].

\(r\) For each turbine engine, a warning means for the oil strainer or filter required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1019   Oil strainer or filter.|§27.1019]], if it has no bypass, to warn the pilot of the occurrence of contamination of the strainer or filter before it reaches the capacity established in accordance with [[0027 Airworthiness standards  normal category rotorcraft#§27.1019   Oil strainer or filter.|§27.1019]](a)(2).
...
\(v\) Warning or caution devices to signal to the flight crew when ferromagnetic particles are detected by the chip detector required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1337   Powerplant instruments.|§27.1337]](e).
...
\(1\) Each fuel quantity indicator must be calibrated to read “zero” during level flight when the quantity of fuel remaining in the tank is equal to the unusable fuel supply determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.959   Unusable fuel supply.|§27.959]];
...
\(1\) Be designed to provide a signal to the device required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1305   Powerplant instruments.|§27.1305]](v) and be provided with a means to allow crewmembers to check, in flight, the function of each detector electrical circuit and signal.
...
\(a\) *General.* Each part of each position light system must meet the applicable requirements of this section, and each system as a whole must meet the requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1387   Position light system dihedral angles.|§§27.1387]] through 27.1397.
...
\(1\) *Intensities in the horizontal plane.* Each intensity in the horizontal plane (the plane containing the longitudinal axis of the rotorcraft and perpendicular to the plane of symmetry of the rotorcraft) must equal or exceed the values in [[0027 Airworthiness standards  normal category rotorcraft#§27.1391   Minimum intensities in the horizontal plane of forward and rear position lights.|§27.1391]].

\(2\) *Intensities in any vertical plane.* Each intensity in any vertical plane (the plane perpendicular to the horizontal plane) must equal or exceed the appropriate value in [[0027 Airworthiness standards  normal category rotorcraft#§27.1393   Minimum intensities in any vertical plane of forward and rear position lights.|§27.1393]], where *I* is the minimum intensity prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1391   Minimum intensities in the horizontal plane of forward and rear position lights.|§27.1391]] for the corresponding angles in the horizontal plane.

\(3\) *Intensities in overlaps between adjacent signals.* No intensity in any overlap between adjacent signals may exceed the values in [[0027 Airworthiness standards  normal category rotorcraft#§27.1395   Maximum intensities in overlapping beams of forward and rear position lights.|§27.1395]], except that higher intensities in overlaps may be used with main beam intensities substantially greater than the minima specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.1391   Minimum intensities in the horizontal plane of forward and rear position lights.|§§27.1391]] and 27.1393, if the overlap intensities in relation to the main beam intensities do not adversely affect signal clarity. When the peak intensity of the forward position lights is greater than 100 candles, the maximum overlap intensities between them may exceed the values in [[0027 Airworthiness standards  normal category rotorcraft#§27.1395   Maximum intensities in overlapping beams of forward and rear position lights.|§27.1395]] if the overlap intensity in Area A is not more than 10 percent of peak position light intensity and the overlap intensity in Area B is not more than 2.5 percent of peak position light intensity.
...
No position light intensity may exceed the applicable values in the following table, except as provided in [[0027 Airworthiness standards  normal category rotorcraft#§27.1389   Position light distribution and intensities.|§27.1389]](b)(3).
...
\(d\) *Color.* Each anticollision light must be aviation red and must meet the applicable requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1397   Color specifications.|§27.1397]].
...
\(2\) Protect the safety equipment from damage caused by being subjected to the inertia loads specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.561   General.|§27.561]].
...
\(b\) It must be demonstrated that the rotorcraft can be safely operated in the continuous maximum and intermittent maximum icing conditions determined under appendix C of [[0029 Airworthiness standards  transport category rotorcraft|Part 29 of this chapter]] within the rotorcraft altitude envelope. An analysis must be performed to establish, on the basis of the rotorcraft's operational needs, the adequacy of the ice protection system for the various components of the rotorcraft.
...
\(1\) It is supplied with airspeed, altitude, and directional data obtained from sources that meet the accuracy requirements of [[0027 Airworthiness standards  normal category rotorcraft#§27.1323   Airspeed indicating system.|§§27.1323]], 27.1325, and 27.1327 of this part, as applicable;
...
\(a\) Each operating limitation specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.1503   Airspeed limitations: general.|§§27.1503]] through 27.1525 and other limitations and information necessary for safe operation must be established.

\(b\) The operating limitations and other information necessary for safe operation must be made available to the crewmembers as prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1541   General.|§§27.1541]] through 27.1589.
...
\(i\) 0.9 times the maximum forward speeds established under [[0027 Airworthiness standards  normal category rotorcraft#§27.309   Design limitations.|§27.309]];

\(ii\) 0.9 times the maximum speed shown under [[0027 Airworthiness standards  normal category rotorcraft#§27.251   Vibration.|§§27.251]] and 27.629; or
...
\(i\) [[0027 Airworthiness standards  normal category rotorcraft#§27.65   Climb: all engines operating.|§27.65]](b) for single engine helicopters; and

\(ii\) [[0027 Airworthiness standards  normal category rotorcraft#§27.67   Climb: one engine inoperative.|§27.67]] for multiengine helicopters.
...
\(1\) The maximum design r.p.m. determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.309   Design limitations.|§27.309]](b); and
...
\(2\) Not more than a value determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.33   Main rotor speed and pitch limits.|§27.33]](a)(1) and (b)(1).

### §27.1519   Weight and center of gravity.

The weight and center of gravity limitations determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.25   Weight limits.|§§27.25]] and 27.27, respectively, must be established as operating limitations.
...
\(2\) The minimum rotational speed shown under the rotor speed requirements in [[0027 Airworthiness standards  normal category rotorcraft#§27.1509   Rotor speed.|§27.1509]](c); and
...
\(ii\) The torque that the main rotor assembly is designed to withstand in showing compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.547   Main rotor structure.|§27.547]](e).
...
\(f\) *Ambient temperature.* For turbine engines, ambient temperature limitations (including limitations for winterization installations, if applicable) must be established as the maximum ambient atmospheric temperature at which compliance with the cooling provisions of [[0027 Airworthiness standards  normal category rotorcraft#§27.1041   General.|§§27.1041]] through 27.1045 is shown.
...
\(c\) The kinds of operation authorized under [[0027 Airworthiness standards  normal category rotorcraft#§27.1525   Kinds of operations.|§27.1525]].
...
\(1\) The markings and placards specified in [[0027 Airworthiness standards  normal category rotorcraft#§27.1545   Airspeed indicator.|§§27.1545]] through 27.1565, and
...
\(1\) Information required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1583   Operating limitations.|§§27.1583]] through 27.1589.

\(2\) Other information that is necessary for safe operation because of design, operating, or handling characteristics.

\(b\) *Approved information.* Each part of the manual listed in [[0027 Airworthiness standards  normal category rotorcraft#§27.1583   Operating limitations.|§§27.1583]] through 27.1589, that is appropriate to the rotorcraft, must be furnished, verified, and approved, and must be segregated, identified, and clearly distinguished from each unapproved part of that manual.
...
\(1\) Limitations required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1521   Powerplant limitations.|§27.1521]].

\(2\) Explanation of the limitations, when appropriate.

\(3\) Information necessary for marking the instruments required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1549   Powerplant instruments.|§§27.1549]] through 27.1553.

\(c\) *Weight and loading distribution.* The weight and center of gravity limits required by [[0027 Airworthiness standards  normal category rotorcraft#§27.25   Weight limits.|§§27.25]] and 27.27, respectively, must be furnished. If the variety of possible loading conditions warrants, instructions must be included to allow ready observance of the limitations.

\(d\) *Flight crew.* When a flight crew of more than one is required, the number and functions of the minimum flight crew determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.1523   Minimum flight crew.|§27.1523]] must be furnished.
...
\(g\) *Altitude.* The altitude established under [[0027 Airworthiness standards  normal category rotorcraft#§27.1527   Maximum operating altitude.|§27.1527]] and an explanation of the limiting factors must be furnished.
...
\(b\) For multiengine rotorcraft, information identifying each operating condition in which the fuel system independence prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.953   Fuel system independence.|§27.953]] is necessary for safety must be furnished, together with instructions for placing the fuel system in a configuration used to show compliance with that section.

\(c\) For helicopters for which a V*NE* (power-off) is established under [[0027 Airworthiness standards  normal category rotorcraft#§27.1505   Never-exceed speed.|§27.1505]](c), information must be furnished to explain the V*NE* (power-off) and the procedures for reducing airspeed to not more than the V*NE* (power-off) following failure of all engines.

\(d\) For each rotorcraft showing compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.1353   Storage battery design and installation.|§27.1353]] (g)(2) or (g)(3), the operating procedures for disconnecting the battery from its charging source must be furnished.
...
\(g\) The airspeeds and rotor speeds for minimum rate of descent and best glide angle as prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.71   Autorotation performance.|§27.71]] must be provided.
...
\(a\) The Rotorcraft Flight Manual must contain the following information, determined in accordance with [[0027 Airworthiness standards  normal category rotorcraft#§27.49   Performance at minimum operating speed.|§§27.49]] through 27.87 and 27.143(c) and (d):
...
\(iii\) For reciprocating engine-powered rotorcraft, the maximum atmospheric temperature at which compliance with the cooling provisions of [[0027 Airworthiness standards  normal category rotorcraft#§27.1041   General.|§§27.1041]] through 27.1045 is shown; and

\(iv\) Glide distance as a function of altitude when autorotating at the speeds and conditions for minimum rate of descent and best glide as determined in [[0027 Airworthiness standards  normal category rotorcraft#§27.71   Autorotation performance.|§27.71]].

\(b\) The Rotorcraft Flight Manual must contain—

\(1\) In its performance information section any pertinent information concerning the takeoff weights and altitudes used in compliance with [[0027 Airworthiness standards  normal category rotorcraft#§27.51   Takeoff.|§27.51]]; and

\(2\) The horizontal takeoff distance determined in accordance with [[0027 Airworthiness standards  normal category rotorcraft#§27.65   Climb: all engines operating.|§27.65]](a)(2)(i).
...
There must be loading instructions for each possible loading condition between the maximum and minimum weights determined under [[0027 Airworthiness standards  normal category rotorcraft#§27.25   Weight limits.|§27.25]] that can result in a center of gravity beyond any extreme prescribed in [[0027 Airworthiness standards  normal category rotorcraft#§27.27   Center of gravity limits.|§27.27]], assuming any probable occupant weights.
...
\(a\) This appendix specifies requirements for the preparation of Instructions for Continued Airworthiness as required by [[0027 Airworthiness standards  normal category rotorcraft#§27.1529   Instructions for Continued Airworthiness.|§27.1529]].
...
VIII\. *Equipment, systems, and installation.* The basic equipment and installation must comply with [[0029 Airworthiness standards  transport category rotorcraft#§29.1303   Flight and navigation instruments.|§§29.1303]], 29.1431, and 29.1433 through Amendment 29-14, with the following exceptions and additions:

\(a\) *Flight and Navigation Instruments.* (1) A magnetic gyro-stablized direction indicator instead of a gyroscopic direction indicator required by [[0029 Airworthiness standards  transport category rotorcraft#§29.1303   Flight and navigation instruments.|§29.1303]](h); and

\(2\) A standby attitude indicator which meets the requirements of [[0029 Airworthiness standards  transport category rotorcraft#§29.1303   Flight and navigation instruments.|§§29.1303]](g)(1) through (7) instead of a rate-of-turn indicator required by [[0029 Airworthiness standards  transport category rotorcraft#§29.1303   Flight and navigation instruments.|§29.1303]](g). For two-pilot configurations, one pilot's primary indicator may be designated for this purpose. If standby batteries are provided, they may be charged from the aircraft electrical system if adequate isolation is incorporated.

\(b\) *Miscellaneous requirements.* (1) Instrument systems and other systems essential for IFR flight that could be adversely affected by icing must be adequately protected when exposed to the continuous and intermittent maximum icing conditions defined in appendix C of [[0029 Airworthiness standards  transport category rotorcraft|Part 29 of this chapter]], whether or not the rotorcraft is certificated for operation in icing conditions.
...
X. Electrical and electronic system lightning protection. For regulations concerning lightning protection for electrical and electronic systems, see [[0027 Airworthiness standards  normal category rotorcraft#§27.1316   Electrical and electronic system lightning protection.|§27.1316]].
...
C27.2   Applicable part 29 sections. The following sections of [[0029 Airworthiness standards  transport category rotorcraft|part 29 of this chapter]] must be met in addition to the requirements of this part:
