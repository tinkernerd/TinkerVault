...
\(c\) A launch operator must prepare and file an application to modify a launch license under [[0413 License application procedures|part 413 of this chapter]]. The launch operator must identify any part of its license or license application that a proposed modification would change or affect.
...
\(a\) *General.* A launch operator must satisfy the launch reporting requirements and launch specific updates required by this section and by the terms of the launch operator's license. A launch operator must file any change to the information in the license application, not identified by this section, with the FAA as a request for license modification as required by [[0417 Launch safety#§417.11   Continuing accuracy of license application; application for modification of license.|§417.11]].
...
\(i\) Payload information required by [[0415 Launch license#§415.59   Information requirements for payload review.|§415.59]] of this chapter; and
...
A launch operator must comply with financial responsibility requirements as required by [[0440 Financial responsibility|part 440 of this chapter]] and as specified in a license or license order.
...
\(a\) *Flight safety system.* For each launch vehicle, vehicle component, and payload, a launch operator must use a flight safety system that satisfies subpart D of this part as follows, unless [[0417 Launch safety#§417.125   Launch of an unguided suborbital launch vehicle.|§417.125]] applies.
...
\(c\) *Debris thresholds.* A launch operator's flight safety analysis, performed as required by paragraph (f) of this section, must account for any inert debris impact with a mean expected kinetic energy at impact greater than or equal to 11 ft-lbs and, except for the far field blast overpressure effects analysis of [[0417 Launch safety#§417.229   Far-field overpressure blast effects analysis.|§417.229]], a peak incident overpressure greater than or equal to 1.0 psi due to any explosive debris impact.
...
\(2\) *Flight safety rules.* All flight safety rules required by [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]].
...
\(7\) *Flight safety operations.* A description of the flight safety related tests, reviews, rehearsals, and other flight safety operations that a launch operator will conduct under [[0417 Launch safety#§417.115   Tests.|§§417.115]] through 417.121. A flight safety plan must contain or incorporate by reference written procedures for accomplishing all flight safety operations.
...
\(i\) Launch angle limits, as required by [[0417 Launch safety#§417.125   Launch of an unguided suborbital launch vehicle.|§417.125]](c)(3); and

\(ii\) All procedures for measurement of launch day winds and for performing wind weighting as required by [[0417 Launch safety#§417.125   Launch of an unguided suborbital launch vehicle.|§§417.125]] and 417.233.
...
\(i\) Total net explosive weight of each of the launch operator's liquid and solid propellants and other explosives for each explosive hazard facility as defined by [[0420 License to operate a launch site|part 420 of this chapter]].

\(ii\) For each toxic propellant, any hazard controls and process constraints determined under the launch operator's toxic release hazard analysis for launch processing performed as required by [[0417 Launch safety#§417.229   Far-field overpressure blast effects analysis.|§417.229]] and appendix I of this part.

\(iii\) The explosive and occupancy limits for each explosive hazard facility.

\(iv\) Individual explosive item information, including configuration (such as, solid motor, motor segment, or liquid propellant container), explosive material, net explosive weight, storage hazard classification and compatibility group as defined by [[0420 License to operate a launch site|part 420 of this chapter]].
...
\(4\) A description of the process for ensuring that the person designated under [[0417 Launch safety#§417.103   Safety organization.|§417.103]](b)(2) reviews and approves any procedures and procedure changes for safety implications.
...
\(8\) Identification of each safety clear zone and hazard area established as required by [[0417 Launch safety#§417.411   Safety clear zones for hazardous operations.|§§417.411]] and 417.413, respectively.
...
\(12\) Description of each hazard control required by the ground safety analysis for each task that creates a public or launch location hazard. The hazard control must satisfy [[0417 Launch safety#§417.407   Hazard control implementation.|§417.407]](b).
...
\(15\) Generic emergency procedures that apply to all emergencies and the emergency procedures that apply to each specific task that may create a public hazard, including any task that involves hazardous material, as required by [[0417 Launch safety#§417.407   Hazard control implementation.|§417.407]].
...
\(2\) Identify all certified personnel, by position, as required by [[0417 Launch safety#§417.105   Launch personnel qualifications and certification.|§417.105]], who operate and maintain the support equipment and instrumentation;
...
\(1\) Demonstrate compliance with the requirements of [[0417 Launch safety#§417.309   Flight safety system analysis.|§417.309]](b)(2);
...
\(I\) Identification of hazardous materials, as defined by [[0401 Organization and definitions#§401.5   Definitions.|§401.5]] of this chapter, involved in the event, whether on the launch vehicle, payload, or on the ground;
...
\(ii\) Provide any hazard area information prepared as required by [[0417 Launch safety#§417.225   Debris risk analysis.|§417.225]] or §417.235 to the local United States Coast Guard or equivalent local authority for issuance of the notices to mariners;

\(iii\) Provide hazard area information prepared as required by [[0417 Launch safety#§417.223   Flight hazard area analysis.|§417.223]] or [[0417 Launch safety#§417.233   Analysis for an unguided suborbital launch vehicle flown with a wind weighting safety system.|§417.233]] for each aircraft hazard area within a flight corridor to the FAA Air Traffic Control (ATC) office or equivalent local authority having jurisdiction over the airspace through which the launch will take place for the issuance of notices to airmen;
...
\(iii\) Identification of personnel, by position, who perform each operation or specific action, including reporting to the person designated under [[0417 Launch safety#§417.103   Safety organization.|§417.103]](b)(3);
...
\(ii\) Any command transmitter system required by section D417.9 has sufficient coverage from lift-off to the point in flight where the flight safety system is no longer required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](a);
...
\(1\) The flight safety system must terminate flight when valid, real-time data indicate the launch vehicle has violated any flight safety limit of [[0417 Launch safety#§417.213   Flight safety limits analysis.|§417.213]];

\(2\) The flight safety system must terminate flight at the straight-up-time required by [[0417 Launch safety#§417.215   Straight-up time analysis.|§417.215]] if the launch vehicle continues to fly a straight up trajectory and, therefore, does not turn downrange when it should;
...
\(4\) The flight termination rules must incorporate the data-loss flight times and planned safe flight state of [[0417 Launch safety#§417.219   Data loss flight time and planned safe flight state analyses.|§417.219]], including each of the following:
...
\(5\) For any gate established under [[0417 Launch safety#§417.217   Overflight gate analysis.|§417.217]], both of the following apply:
...
\(6\) For any hold-and-resume gate established under [[0417 Launch safety#§417.218   Hold-and-resume gate analysis.|§417.218]];
...
\(e\) *Flight safety system safing.* For a launch that uses a flight safety system, the launch safety rules must ensure that any safing of the flight safety system occurs on or after the point in flight where the flight safety system is no longer required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](b).
...
\(c\) *Ground system testing.* A launch operator must only use a system or equipment used to support hazardous ground operations identified by the ground safety analysis required by [[0417 Launch safety#§417.405   Ground safety analysis.|§417.405]] that satisfies the test requirements of paragraph (a) of this section.
...
\(ii\) A launch operator must assign and certify flight safety personnel as required by [[0417 Launch safety#§417.105   Launch personnel qualifications and certification.|§417.105]].
...
\(viii\) Results of rehearsals conducted as required by [[0417 Launch safety#§417.119   Rehearsals.|§417.119]].
...
\(a\) *General.* A launch operator must perform safety critical preflight operations that protect the public from the adverse effects of hazards associated with launch processing and flight of a launch vehicle. The launch operator must identify all safety critical preflight operations in the launch schedule required by [[0417 Launch safety#§417.17   Launch reporting requirements and launch specific updates.|§417.17]](b)(1). Safety critical preflight operations must include those defined in this section.

\(b\) *Countdown.* A launch operator must implement its countdown plan, of [[0417 Launch safety#§417.111   Launch plans.|§417.111]](l), for each launch. A launch operator must disseminate a countdown plan to all personnel responsible for the countdown and flight of a launch vehicle, and each person must follow that plan.

\(c\) *Collision avoidance.* A launch operator must coordinate with United States Strategic Command to obtain a collision avoidance analysis, also referred to as a conjunction on launch assessment, as required by [[0417 Launch safety#§417.231   Collision avoidance analysis.|§417.231]]. A launch operator must implement flight commit criteria as required by [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]](c) to ensure that each launch meets all the criteria of [[0417 Launch safety#§417.107   Flight safety.|§417.107]](e).

\(d\) *Meteorological data.* A launch operator must conduct operations and coordinate with weather organizations, as needed, to obtain accurate meteorological data to support the flight safety analysis required by subpart C of this part and to ensure compliance with the flight commit criteria required by [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]].

\(e\) *Local notification.* A launch operator must implement its local agreements and public coordination plan of [[0417 Launch safety#§417.111   Launch plans.|§417.111]](i).

\(f\) *Hazard area surveillance.* A launch operator must implement its hazard area surveillance and clearance plan, of [[0417 Launch safety#§417.111   Launch plans.|§417.111]](j), to meet the public safety criteria of [[0417 Launch safety#§417.107   Flight safety.|§417.107]](b) for each launch.
...
\(b\) *Need for flight safety system.* A launch operator must launch an unguided suborbital launch vehicle with a flight safety system in accordance with [[0417 Launch safety#§417.107   Flight safety.|§417.107]] (a) and subpart D of this part unless one of the following exceptions applies:
...
\(g\) *Post-launch review.* A launch operator must ensure that the post-launch report required by [[0417 Launch safety#§417.25   Post launch report.|§417.25]] includes:
...
\(a\) This subpart contains requirements for performing the flight safety analysis required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](f).

\(b\) The flight safety analysis requirements of this subpart apply to the flight of any launch vehicle that must use a flight safety system as required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](a), except as permitted by paragraph (d) of this section.

\(c\) The flight safety analysis requirements of [[0417 Launch safety#§417.203   Compliance.|§§417.203]], 417.205, 417.207, 417.211, 417.223, 417.224, 417.225, 417.227, 417.229, 417.231, and 417.233 apply to the flight of any unguided suborbital launch vehicle that uses a wind-weighting safety system. Appendices B, C, and I of this part also apply.

\(d\) For any alternative flight safety system approved by the FAA under [[0417 Launch safety#§417.301   General.|§417.301]](b), the FAA will determine during the licensing process which of the analyses required by this subpart apply.
...
\(c\) *Alternate analysis method.* The FAA will approve an alternate flight safety analysis method if a launch operator demonstrates, in accordance with [[0406 Investigations, enforcement, and administrative review#§406.3   Submissions; oral presentation in license, permit, and payload actions.|§406.3]](b), that its proposed analysis method provides an equivalent level of fidelity to that required by this subpart. A launch operator must demonstrate that an alternate flight safety analysis method is based on accurate data and scientific principles and is statistically valid. The FAA will not find a launch operator's application for a license or license modification sufficiently complete to begin review under [[0413 License application procedures#§413.11   Acceptance of an application.|§413.11]] of this chapter until the FAA approves the alternate flight safety analysis method.
...
\(1\) *Risk assessment.* When demonstrating control of risk through risk assessment, the analysis must demonstrate that any risk to the public satisfies the public risk criteria of [[0417 Launch safety#§417.107   Flight safety.|§417.107]](b). The analysis must account for the variability associated with:
...
\(1\) All time delays, as established by the time delay analysis of [[0417 Launch safety#§417.221   Time delay analysis.|§417.221]];
...
\(c\) *Gates.* If a launch involves flight over any populated or other protected area, the flight safety analysis must establish a gate as required by [[0417 Launch safety#§417.217   Overflight gate analysis.|§§417.217]] and 417.218.
...
\(a\) *General.* A flight safety analysis must include a time delay analysis that establishes the mean elapsed time between the violation of a flight termination rule and the time when the flight safety system is capable of terminating flight for use in establishing flight safety limits as required by [[0417 Launch safety#§417.213   Flight safety limits analysis.|§417.213]].
...
\(a\) *General.* A flight safety analysis must include a flight hazard area analysis that identifies any regions of land, sea, or air that must be surveyed, publicized, controlled, or evacuated in order to control the risk to the public from debris impact hazards. The risk management requirements of [[0417 Launch safety#§417.205   General.|§417.205]](a) apply. The analysis must account for, at a minimum:

\(1\) All trajectory times from liftoff to the planned safe flight state of [[0417 Launch safety#§417.219   Data loss flight time and planned safe flight state analyses.|§417.219]](c), including each planned impact, for an orbital launch, and through final impact for a suborbital launch;
...
\(6\) Debris identified by the debris analysis of [[0417 Launch safety#§417.211   Debris analysis.|§417.211]]; and
...
For each launch of an unguided suborbital launch vehicle flown with a wind weighting safety system, in addition to the other requirements in this subpart outlined in [[0417 Launch safety#§417.201   Scope and applicability.|§417.201]](c), the flight safety analysis must:
...
\(2\) A command control system that satisfies [[0417 Launch safety#§417.303   Command control system requirements.|§§417.303]] and 417.305;

\(3\) Each support system required by [[0417 Launch safety#§417.307   Support systems.|§417.307]]; and

\(4\) The functions of any personnel who operate flight safety system hardware or software including a flight safety crew that satisfies [[0417 Launch safety#§417.311   Flight safety crew roles and qualifications.|§417.311]].
...
\(i\) Comply with a launch operator's flight safety system compliance matrix of [[0415 Launch license#§415.127   Flight safety system design and operation data.|§415.127]](g) that accounts for all the design, installation, and monitoring requirements of this subpart, including the referenced appendices; and

\(ii\) Comply with a launch operator's testing compliance matrix of [[0415 Launch license#§415.129   Flight safety system test data.|§415.129]](b) that accounts for all the test requirements of this subpart, including the referenced appendices.
...
\(j\) *Command control system monitoring and control.* A command control system must provide for monitoring and control of the system from the flight safety system displays and controls required by [[0417 Launch safety#§417.307   Support systems.|§417.307]](f), including real-time selection of a transmitter, transmitter site, communication circuits, and antenna configuration.
...
\(4\) Transmit an output bandwidth that is consistent with the signal spectrum power used in the link analysis of [[0417 Launch safety#§417.309   Flight safety system analysis.|§417.309]](f); and
...
\(ii\) When the vehicle is centered in the antenna pattern at the beginning of the malfunction, account for the launch vehicle's malfunction turn capability determined by the analysis of [[0417 Launch safety#§417.209   Malfunction turn analysis.|§417.209]], the data loss flight times of [[0417 Launch safety#§417.219   Data loss flight time and planned safe flight state analyses.|§417.219]], and the time delay of [[0417 Launch safety#§417.221   Time delay analysis.|§417.221]].
...
\(b\) *Acceptance testing.* (1) All new or modified command control system hardware and software must undergo acceptance testing to verify that the system satisfies the requirements of [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]].
...
\(3\) Each acceptance test must measure the performance parameters that demonstrate whether the requirements of [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]] are satisfied.

\(4\) Any computing system, software, or firmware that performs a software safety critical function must undergo validation testing and satisfy [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]]. If command control system hardware interfaces with software, the interface must undergo validation testing.

\(c\) *Preflight testing*—(1) *General.* For each launch, a command control system must undergo preflight testing to verify that the system satisfies the requirements of [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]] for the launch.
...
\(7\) The launch vehicle tracking error from all sources, including data latency and any possible gaps or dropouts in tracking coverage, must be consistent with the flight safety limits of [[0417 Launch safety#§417.213   Flight safety limits analysis.|§417.213]] and the flight safety system time delay of [[0417 Launch safety#§417.221   Time delay analysis.|§417.221]].
...
\(1\) Satisfy [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]] for any computing system, software, or firmware that must operate properly to ensure the accuracy of the data;
...
\(11\) The system must include a digital countdown for use in implementing the flight termination rules of [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]] that apply data loss flight times and the planned safe flight state. The system must also include a manual method of applying the data loss flight times in the event that the digital countdown malfunctions.
...
\(ii\) The command transmitter failover criteria of [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]](g) including the lowest output power provided by the transmitter system;
...
\(h\) *Software and firmware.* Any computing system, software, or firmware that performs a software safety critical function must undergo the analysis needed to ensure reliable operation and satisfy [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]].
...
\(a\) A flight safety crew must operate the flight safety system hardware. A flight safety crew must document each flight safety crew position description and maintain documentation on individual crew qualifications, including education, experience, and training as part of the personnel certification program required by [[0417 Launch safety#§417.105   Launch personnel qualifications and certification.|§417.105]].

\(b\) A flight safety crew must be able to demonstrate the knowledge, skills, and abilities needed to operate the flight safety system hardware in accordance with [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]].
...
\(e\) *Alternate methods.* The FAA will approve an alternate hazard control method if a launch operator demonstrates, in accordance with [[0406 Investigations, enforcement, and administrative review#§406.3   Submissions; oral presentation in license, permit, and payload actions.|§406.3]](b), that its proposed hazard control method provides an equivalent level of safety to that required by this subpart.
...
\(4\) Trace any procedural hazard control identified to a written procedure, and approved by the person designated under [[0417 Launch safety#§417.103   Safety organization.|§417.103]](b)(2) or the person's designee, with the paragraph or step number of the procedure specified;
...
\(7\) Maintain records, as required by [[0417 Launch safety#§417.15   Records.|§417.15]], of the documentation that verifies the information in the ground safety analysis.
...
\(1\) System hazard controls that satisfy [[0417 Launch safety#§417.409   System hazard controls.|§417.409]];

\(2\) Safety clear zones for hazardous operations that satisfy [[0417 Launch safety#§417.411   Safety clear zones for hazardous operations.|§417.411]];

\(3\) Hazard areas and controls for allowing public access that satisfy [[0417 Launch safety#§417.413   Hazard areas.|§417.413]];

\(4\) Hazard controls after launch or an attempt to launch that satisfy [[0417 Launch safety#§417.415   Post-launch and post-flight-attempt hazard controls.|§417.415]]; and

\(5\) Controls for propellant and explosive hazards that satisfy [[0417 Launch safety#§417.417   Propellants and explosives.|§417.417]].
...
\(4\) Ensure computing systems and software used to control a public hazard satisfy the requirements of [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]].
...
\(6\) Ensure qualified and certified personnel, as defined in [[0417 Launch safety#§417.105   Launch personnel qualifications and certification.|§417.105]], conduct the inspections.
...
\(a\) A launch operator must comply with the explosive safety criteria in [[0420 License to operate a launch site|part 420 of this chapter]].

\(b\) A launch operator must ensure that:

\(1\) The explosive site plan satisfies [[0420 License to operate a launch site|part 420 of this chapter]];
...
\(2\) Keep ordnance safety devices, as required by [[0417 Launch safety#§417.409   System hazard controls.|§417.409]], in place until the launch complex is cleared as part of the final launch countdown. No members of the public may re-enter the complex until each safety device is re-established.
...
\(6\) Include lightning protection on each facility used to store or process explosives to prevent inadvertent initiation of propellants and explosives due to lightning unless the facility complies with the lightning protection criteria of [[0420 License to operate a launch site#§420.71   Lightning protection.|§420.71]] of this part.

\(e\) A launch operator, in the event of an emergency, must perform the accident investigation plan as defined in [[0417 Launch safety#§417.111   Launch plans.|§417.111]](h).
...
The requirements of this appendix apply to the methods for performing the flight safety analysis required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](f) and subpart C of this part. The methodologies contained in this appendix provide an acceptable means of satisfying the requirements of subpart C and provide a standard and a measure of fidelity against which the FAA will measure any proposed alternative analysis approach. This appendix also identifies the analysis products that a launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).

# A417.3   Applicability

The requirements of this appendix apply to a launch operator and the launch operator's flight safety analysis unless the launch operator clearly and convincingly demonstrates that an alternative approach provides an equivalent level of safety. If a Federal launch range performs the launch operator's analysis, [[0417 Launch safety#§417.203   Compliance.|§417.203]](d) applies. Section A417.33 applies to the flight of any unguided suborbital launch vehicle that uses a wind-weighting safety system. All other sections of this appendix apply to the flight of any launch vehicle required to use a flight safety system as required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](a). For any alternative flight safety system approved by the FAA as required by [[0417 Launch safety#§417.301   General.|§417.301]](b), the FAA will determine the applicability of this appendix during the licensing process.

# A417.5   General

A launch operator's flight safety analysis must satisfy the requirements for public risk management and the requirements for the compatibility of the input and output of dependent analyses of [[0417 Launch safety#§417.205   General.|§417.205]].

# A417.7   Trajectory

\(a\) *General.* A flight safety analysis must include a trajectory analysis that satisfies the requirements of [[0417 Launch safety#§417.207   Trajectory analysis.|§417.207]]. This section applies to the computation of each of the trajectories required by [[0417 Launch safety#§417.207   Trajectory analysis.|§417.207]] and to each trajectory analysis product that a launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(a\) *General.* A flight safety analysis must include a malfunction turn analysis that satisfies the requirements of [[0417 Launch safety#§417.209   Malfunction turn analysis.|§417.209]]. This section applies to the computation of the malfunction turns and the production of turn data required by [[0417 Launch safety#§417.209   Malfunction turn analysis.|§417.209]] and to the malfunction turn analysis products that a launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(a\) *General.* A flight safety analysis must include a debris analysis that satisfies the requirements of [[0417 Launch safety#§417.211   Debris analysis.|§417.211]]. This section applies to the debris data required by [[0417 Launch safety#§417.211   Debris analysis.|§417.211]] and the debris analysis products that a launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(a\) *General.* A flight safety analysis must include a flight safety limits analysis that satisfies the requirements of [[0417 Launch safety#§417.213   Flight safety limits analysis.|§417.213]]. This section applies to the computation of the flight safety limits and identifying the location of populated or other protected areas as required by [[0417 Launch safety#§417.213   Flight safety limits analysis.|§417.213]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(c\) *Risk management.* The requirements for public risk management of [[0417 Launch safety#§417.205   General.|§417.205]](a) apply to a flight safety limits analysis. When employing risk assessment, the analysis must establish flight safety limits that satisfy paragraph (b) of this section, account for the products of the debris risk analysis performed as required by section A417.25, and ensure that any risk to the public satisfies the public risk criteria of [[0417 Launch safety#§417.107   Flight safety.|§417.107]](b). When employing hazard isolation, the analysis must establish flight safety limits in accordance with the following:
...
\(a\) *General.* A flight safety analysis must include a straight-up time analysis that satisfies the requirements of [[0417 Launch safety#§417.215   Straight-up time analysis.|§417.215]]. This section applies to the computation of straight-up time as required by [[0417 Launch safety#§417.215   Straight-up time analysis.|§417.215]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e). The analysis must establish a straight-up time as the latest time-after-liftoff, assuming a launch vehicle malfunctioned and flew in a vertical or near vertical direction above the launch point, at which activation of the launch vehicle's flight termination system or breakup of the launch vehicle would not cause hazardous debris or critical overpressure to affect any populated or other protected area.
...
\(a\) *General.* The flight safety analysis for a launch that involves flight over a populated or other protected area must include an overflight gate analysis that satisfies the requirements of [[0417 Launch safety#§417.217   Overflight gate analysis.|§417.217]]. This section applies to determining a gate as required by [[0417 Launch safety#§417.217   Overflight gate analysis.|§417.217]] and the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e). The analysis must determine the portion, referred to as a gate, of a flight safety limit, through which a launch vehicle's tracking representation will be allowed to proceed without flight termination.
...
\(2\) When establishing a gate in a flight safety limit, the analysis must ensure that the launch vehicle flight satisfies the flight safety requirements of [[0417 Launch safety#§417.107   Flight safety.|§417.107]].
...
\(a\) *General.* A flight safety analysis must include a time delay analysis that satisfies the requirements of [[0417 Launch safety#§417.221   Time delay analysis.|§417.221]]. This section applies to the computation of time delays associated with a flight safety system and other launch vehicle systems and operations as required by [[0417 Launch safety#§417.221   Time delay analysis.|§417.221]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(a\) *General.* A flight safety analysis must include a flight hazard area analysis that satisfies the requirements of [[0417 Launch safety#§417.223   Flight hazard area analysis.|§417.223]]. This section applies to the determination of flight hazard areas for orbital and suborbital launch vehicles that use a flight termination system to protect the public as required by [[0417 Launch safety#§417.223   Flight hazard area analysis.|§417.223]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e). Requirements that apply to determining flight hazard areas for an unguided suborbital rocket that uses a wind-weighting safety system are contained in appendix C of this part.
...
\(a\) *General.* A flight safety analysis must include a debris risk analysis that satisfies the requirements of [[0417 Launch safety#§417.225   Debris risk analysis.|§417.225]]. This section applies to the computation of the average number of casualties (Ec) to the collective members of debris hazards from the proposed flight of a launch vehicle as required by [[0417 Launch safety#§417.225   Debris risk analysis.|§417.225]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).
...
\(ii\) The failure probability of the launch operator's flight safety system. A flight safety system failure rate of 0.002 may be used if the flight safety system complies with the flight safety system requirements of subpart D of this part. For an alternate flight safety system approved as required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]](a)(3), the launch operator must demonstrate the validity of the probability of failure through the licensing process.
...
A flight safety analysis must include a toxic release hazard analysis that satisfies the requirements of [[0417 Launch safety#§417.227   Toxic release hazard analysis.|§417.227]]. A launch operator's toxic release hazard analysis must satisfy the methodology requirements of appendix I of this part. A launch operator must file the analysis products identified in appendix I of this part as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e).

# A417.29   Far field blast overpressure effects analysis

\(a\) *General.* A flight safety analysis must include a far field blast overpressure effects hazard analysis that satisfies the requirements of [[0417 Launch safety#§417.229   Far-field overpressure blast effects analysis.|§417.229]]. This section applies to the computation of far field blast overpressure effects from the proposed flight of a launch vehicle as required by [[0417 Launch safety#§417.229   Far-field overpressure blast effects analysis.|§417.229]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e). The analysis must account for distant focus overpressure and any overpressure enhancement to establish the potential for broken windows due to peak incident overpressures below 1.0 psi and related casualties due to falling or projected glass shards. The analysis must employ either paragraph (b) of this section or the risk analysis of paragraph (c) of this section.
...
\(a\) *General.* A flight safety analysis must include a collision avoidance analysis that satisfies the requirements of [[0417 Launch safety#§417.231   Collision avoidance analysis.|§417.231]]. This section applies to a launch operator obtaining a collision avoidance assessment from United States Strategic Command as required by [[0417 Launch safety#§417.231   Collision avoidance analysis.|§417.231]] and to the analysis products that the launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e). United States Strategic Command refers to a collision avoidance analysis for a space launch as a conjunction on launch assessment.
...
This appendix contains requirements to establish aircraft hazard areas, ship hazard areas, and land impact hazard areas. The methodologies contained in this appendix represent an acceptable means of satisfying the requirements of [[0417 Launch safety#§417.107   Flight safety.|§417.107]] and [[0417 Launch safety#§417.223   Flight hazard area analysis.|§417.223]] as they pertain to ship, aircraft, and land hazard areas. This appendix provides a standard and a measure of fidelity against which the FAA will measure any proposed alternative approaches. Requirements for a launch operator's implementation of a hazard area are contained in [[0417 Launch safety#§417.121   Safety critical preflight operations.|§§417.121]](e) and (f).
...
\(a\) This appendix contains methodologies for performing the flight safety analysis required for the launch of an unguided suborbital launch vehicle flown with a wind weighting safety system, except for the hazard area analysis required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]], which is covered in appendix B of this part. This appendix includes methodologies for a trajectory analysis, wind weighting analysis, debris analysis, debris risk analysis, and a collision avoidance analysis.
...
\(1\) Perform a flight safety analysis to determine the launch parameters and conditions under which an unguided suborbital launch vehicle may be flown using a wind weighting safety system as required by [[0417 Launch safety#§417.233   Analysis for an unguided suborbital launch vehicle flown with a wind weighting safety system.|§417.233]].

\(2\) When conducting the flight safety analysis, comply with the safety criteria and operational requirements contained in [[0417 Launch safety#§417.125   Launch of an unguided suborbital launch vehicle.|§417.125]]; and

\(3\) Conduct the flight safety analysis for an unguided suborbital launch vehicle using the methodologies of this appendix and appendix B of this part unless the launch operator demonstrates, in accordance with [[0406 Investigations, enforcement, and administrative review#§406.3   Submissions; oral presentation in license, permit, and payload actions.|§406.3]](b), through the licensing process, that an alternate method provides an equivalent level of fidelity.
...
\(g\) *Trajectory analysis products for a suborbital launch vehicle.* A launch operator must file the following products of a trajectory analysis for an unguided suborbital launch vehicle with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e):
...
\(6\) A launch operator must monitor and verify that any wind variations and maximum wind limits at the time of liftoff are within the flight commit criteria established according to [[0417 Launch safety#§417.113   Launch safety rules.|§417.113]](c).
...
\(d\) *Wind weighting analysis products.* The products of a launch operator's wind weighting analysis filed with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e) must include the following:
...
\(d\) *Debris analysis products.* The products of a debris analysis that a launch operator must file with the FAA as required by [[0417 Launch safety#§417.203   Compliance.|§417.203]](e) must include:
...
\(g\) *Software safety critical functions.* The requirements of [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]] apply to any computing system, software or firmware that is associated with a flight termination system and performs a software safety critical function as defined in [[0417 Launch safety#§417.123   Computing systems and software.|§417.123]].
...
\(d\) At any point along the nominal trajectory from liftoff until no longer required by [[0417 Launch safety#§417.107   Flight safety.|§417.107]], a command destruct system must operate with a radio frequency input signal that has an electromagnetic field intensity of 12 dB below the intensity provided by the command transmitter system under nominal conditions over 95 percent of the radiation sphere surrounding the launch vehicle.
...
\(2\) If a radio command safes a flight termination system, the command control system used for in-flight safing must be single fault tolerant against inadvertent transmission of a safing command under [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]](d).
...
\(b\) *Electronic piece-parts.* Each electronic piece-part that can affect the reliability of an electrical component or electronic circuitry during flight must satisfy [[0417 Launch safety#§417.309   Flight safety system analysis.|§417.309]](b)(2) of this part.
...
\(8\) *Voltage standing wave ratio.* All radio frequency losses within the receiver decoder interface to the antenna system must satisfy the 12-dB margin of [[0417 Launch safety#§417.9   Launch site responsibility.|§417.9]](d) and be repeatable to demonstrate in-family performance. The radio frequency receiving system and the impedance of the receiver decoder must match.
...
\(l\) Each connector that can affect a flight termination system component's reliability during flight must satisfy the requirements of [[0417 Launch safety#§417.309   Flight safety system analysis.|§417.309]](b)(2) of this part.
...
\(d\) Each piece-part that is used in the firing circuit of a safe-and-arm device and that can affect the reliability of the device during flight must satisfy [[0417 Launch safety#§417.309   Flight safety system analysis.|§417.309]](b)(2) of this part.
...
\(d\) Initiation of a destruct charge must result in a flight termination system action in accordance with the flight termination system functional requirements of [[0417 Launch safety#§417.303   Command control system requirements.|§417.303]].
...
\(iii\) The test must use a destruct initiator simulator that satisfies [[0417 Launch safety#§417.307   Support systems.|§417.307]](h) in place of each flight initiator to demonstrate that the command destruct and inadvertent separation destruct systems deliver the required energy to initiate the flight termination system ordnance;
...
\(iv\) The test must use a destruct initiator simulator that satisfies [[0417 Launch safety#§417.307   Support systems.|§417.307]](h) in place of each flight initiator to demonstrate that the command destruct and inadvertent separation destruct systems deliver the energy required to initiate the flight termination system ordnance;
...
This appendix provides methodologies for performing toxic release hazard analysis for the flight of a launch vehicle as required by [[0417 Launch safety#§417.227   Toxic release hazard analysis.|§417.227]] and for launch processing at a launch site in the United States as required by [[0417 Launch safety#§417.407   Hazard control implementation.|§417.407]](f). The requirements of this appendix apply to a launch operator and the launch operator's toxic release hazard analysis unless the launch operator clearly and convincingly demonstrates that an alternative approach provides an equivalent level of safety.
...
\(e\) *Flight toxic release hazard analysis products.* The products of a launch operator's toxic release hazard analysis for launch vehicle flight to be filed in accordance with [[0417 Launch safety#§417.203   Compliance.|§417.203]](e) must include the following:
...
\(i\) A description of the launch operator's toxic risk management process, including an explanation of how the launch operator ensures that any toxic risk from launch meets the toxic risk criteria of [[0417 Launch safety#§417.107   Flight safety.|§417.107]](b).
...
\(a\) *General.* A launch operator must perform a toxic release hazard analysis to determine potential public hazards from toxic releases that will occur during normal launch processing and that will occur in the event of a mishap during launch processing. This section implements the ground safety requirements of [[0417 Launch safety#§417.407   Hazard control implementation.|§417.407]](g). A launch operator must use the results of the toxic release hazard analysis to establish hazard controls for protecting the public. A launch operator must include the toxic release hazard analysis results in the ground safety plan as required by [[0417 Launch safety#§417.111   Launch plans.|§417.111]](c).
...
\(a\) This appendix provides the content and format requirements for a ground safety analysis report. A launch operator must perform a ground safety analysis as required by subpart E of part 417 and document the analysis in a ground safety analysis report that satisfies this appendix, as required by [[0417 Launch safety#§417.402   Compliance.|§417.402]](d).
